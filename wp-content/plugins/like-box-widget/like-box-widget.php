...
Description: Our Widget Facebook like box plugin will help you to display your Facebook like box on your website. You can easily add the Like box into your widgets, that's very simple.
Version: 1.0
Author: wpladge
...
class like_box_widget_facbook extends WP_Widget {
	...
	/*function to display facebook like box*/
	...
	/* Widget Facebook Like Box admin page opions function code */
	...
	public function generete_facbook_widget_page($params){
		...
		$facbook_front.='<div style="font-size:2px;width:2px;height:1px;overflow: hidden;"><a href="http://wpteam.org">WordPress plugin</a></div>';
