	...
	function flexsliderInit(){
		$('.flex-gallery').each(function(){
			...
			imagesLoaded($(this),function(instance){
				...
				$('.flex-gallery .flex-direction-nav li a.flex-next').html('<i class="fa fa-arrow-right"></i>');
				$('.flex-gallery .flex-direction-nav li a.flex-prev').html('<i class="fa fa-arrow-left"></i>');
		...
		$('#featured').orbit({
		 ...
		 sliderAfterSetup();
	 	 ...
	 	 if(!$('body').hasClass('mobile')){
			...
			$('.orbit-wrapper div.slider-nav span.right').html('<i class="fa fa-arrow-right"></i>');
			$('.orbit-wrapper div.slider-nav span.left').html('<i class="fa fa-arrow-left"></i>');
		 }
	}
...
$(window).load(pageLoadHash);
    ...
    function isoClickFilter(){
		 ...
		 if(window.innerWidth > 690 && !navigator.userAgent.match(/(Android|iPod|iPhone|iPad|IEMobile|Opera Mini)/)){
		  ...
		  //update pp
		  setTimeout(updatePrettyPhotoGallery,720);
