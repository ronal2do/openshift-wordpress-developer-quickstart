			...
			<?php if( !is_single() ) { ?>
				<div class="article-content-wrap">
					<div class="post-header">
						...
						<span class="meta-author"><span><?php echo __('Por', NECTAR_THEME_NAME); ?></span> <?php the_author_posts_link(); ?></span> <span class="meta-category">| <?php the_category(', '); ?></span> <span class="meta-comment-count">| <a href="<?php comments_link(); ?>">
						<?php comments_number( __('Sem Comentários', NECTAR_THEME_NAME), __('1 Comentário ', NECTAR_THEME_NAME), __('% Comentários', NECTAR_THEME_NAME) ); ?></a></span>
					</div><!--/post-header-->
				...
				<?php
					...
					if(empty( $post->post_excerpt ) && $use_excerpt != 'true') {
						the_content('<span class="continue-reading">'. __("Continue", NECTAR_THEME_NAME) . '</span>'); 
					}
					...
					//excerpt
						...
						echo '<div class="excerpt">';
							the_excerpt();
						echo '</div>';
						echo '<a class="more-link" href="' . get_permalink() . '"><span class="continue-reading">'. __("Continue", NECTAR_THEME_NAME) .'</span></a>';
					}
