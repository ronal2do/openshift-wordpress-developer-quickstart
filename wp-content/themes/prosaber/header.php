		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col span_9 col_last">
					...
					<?php if(has_nav_menu('top_nav')) echo '<a href="#mobilemenu" id="toggle-nav"><i class="fa fa-bars" style="color:#ff0000;"></i></a>'; ?>
					...
					if($sideWidgetArea == '1') { ?>
						<div class="slide-out-widget-area-toggle">
							<div> <a href="#sidewidgetarea" class="closed"> <strong class="doe col span_3slider-nav">DOE</strong> </a> </div> 
       					</div>
					<?php } ?>
			...
			<?php 
				if(has_nav_menu('top_nav')) {
					...
					<form action="'.home_url().'" method="GET">
			      		<input type="text" name="s" value="" placeholder="'.__('Buscar..', NECTAR_THEME_NAME) .'" />
					</form> 
					</li>';
				}
				else {
