...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php  if(!empty($options['theme-skin']) && $options['theme-skin'] == 'ascend') echo '<span><i>'. __("Join the discussion").'</i></span>' ?> <?php comments_number(__('Sem Comentários',NECTAR_THEME_NAME), __('Um Comentário', NECTAR_THEME_NAME), __('% Comentários', NECTAR_THEME_NAME) );?></h3>
