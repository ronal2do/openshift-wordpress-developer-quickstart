	...
	if($theme_skin != 'ascend') { ?>
		<div class="container">
			<div id="single-below-header" class="<?php echo $fullscreen_class; ?> custom-skip">
				...
				<span class="meta-comment-count"><i class="icon-default-style steadysets-icon-chat-3"></i> <a href="<?php comments_link(); ?>"><?php comments_number( __('Sem Comentários', NECTAR_THEME_NAME), __('1 Comentário ', NECTAR_THEME_NAME), __('% Comentários', NECTAR_THEME_NAME) ); ?></a></span>
	...
	<div class="container main-content">
					...
					<div class="row heading-title">
						<div class="col span_12 section-title blog-title">
							...
							<div id="single-below-header">
								<span class="meta-author vcard author"><span class="fn"><?php echo __('Por', NECTAR_THEME_NAME); ?> <?php the_author_posts_link(); ?></span></span> 
								...
								<span class="meta-comment-count"><a href="<?php comments_link(); ?>"><?php comments_number( __('Sem Comentários', NECTAR_THEME_NAME), __('1 Comentário ', NECTAR_THEME_NAME), __('% Comentários', NECTAR_THEME_NAME) ); ?></a></span>
		...
		<div class="row">
			...
			<div id="single-below-header" class="<?php echo $fullscreen_class; ?> custom-skip">
				<span class="meta-share-count"><i class="icon-default-style steadysets-icon-share"></i> <?php echo '<a href=""><span class="share-count-total">0</span> <span class="plural">'. __('Shares',NECTAR_THEME_NAME) . '</span> <span class="singular">'. __('Share',NECTAR_THEME_NAME) .'</span> </a>'; nectar_blog_social_sharing(); ?> </span>
				<span class="meta-category"><i class="icon-default-style steadysets-icon-book2"></i> <?php the_category(', '); ?></span>
				<span class="meta-comment-count"><i class="icon-default-style steadysets-icon-chat-3"></i> <a class="comments-link" href="<?php comments_link(); ?>"><?php comments_number( __('Sem Comentários', NECTAR_THEME_NAME), __('1 Comentário ', NECTAR_THEME_NAME), __('% Comentários', NECTAR_THEME_NAME) ); ?></a></span>
			</div><!--/single-below-header-->
