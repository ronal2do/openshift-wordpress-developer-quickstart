    ...
    <div class="images">
    	...
    	<div class="iosSlider product-slider">
    		...
    		<div class="slider_controls">
				 <div class="nav_wrap">
		       		 <a href="#" class="prev_slide" onclick="return false;"><span class="fa fa-arrow-left"></span></a>
		       		 <a href="#" class="next_slide" onclick="return false;"><span class="fa fa-arrow-right"></span></a>
		        </div>
       		</div>
		</div>
	...
	<?php if ( $product_attach_ids ) { 
        ...
        <div class="iosSlider product-thumbs" style="min-height:<?php echo ($img_size['height']).'px'; ?>!important">
			<div class ="slider">
        	 ...
        	 <div class="slider_controls">
				  <div class="nav_wrap">
		       		 <a href="#" onclick="return false;" class="prev_slide"><span class="fa fa-arrow-left"></span></a>
		       		 <a href="#" onclick="return false;" class="next_slide"><span class="fa fa-arrow-right"></span></a>
		        </div>
       		</div>
		</div>
